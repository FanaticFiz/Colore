...
public class grdAd_Game_t1 extends BaseAdapter 
{
	...
	// Конструктор
	public grdAd_Game_t1(Context context, ArrayList<String> _arrayfromXML, int xMLgame_type, int[] _array_legal_moovs, int _LastMoov, int _EndPoint) 
	{
		mContext = context;
	...
	{  	
	    ...
	    for (int i = 0; i<arrayPicture.size(); i++)
	    {
	    	...
	    	//	13	-	Прозрачный!!!
	    	//	14 	-	лососевый )) 
			case 0:		arrayPicture.set(i, "ball0");	break;
			case 1:		arrayPicture.set(i, "ball1");	break;
			case 2:		arrayPicture.set(i, "ball2");	break;
			case 3:		arrayPicture.set(i, "ball3");	break;
			case 4:		arrayPicture.set(i, "ball4");	break;
			case 5:		arrayPicture.set(i, "ball5");	break;
			case 6:		arrayPicture.set(i, "ball6");	break;
			case 7:		arrayPicture.set(i, "ball7");	break;
			case 8:	 	arrayPicture.set(i, "ball8");	break;
			case 9:		arrayPicture.set(i, "ball9");	break;
			case 10:	arrayPicture.set(i, "ball10");	break;
			case 11:	arrayPicture.set(i, "ball11");	break;
			case 12:	arrayPicture.set(i, "ball12");	break;
			case 14:	arrayPicture.set(i, "ball14");	break;
			default:
